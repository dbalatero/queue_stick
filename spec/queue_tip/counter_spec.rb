...
describe QueueStick::Counter do
  ...
  describe "name" do
    it "should return the name given to the constructor" do
      counter = QueueStick::Counter.new(:my_counter)
  ...
  describe "count" do
    ...
    it "should be equal to the specified construction value if given" do
      counter = QueueStick::Counter.new(:my_counter, 50)
